...
import { sampleProfiles, sampleProofs,
  sampleVerifications, sampleAddressBasedVerifications } from './sampleData'
...
export function runOwnerAddressBasedProofsUnitTests() {
  test('containsValidAddressProofStatement', (t) => {
    ...
    const hackerNewsProofStatement =
    profileServices.hackerNews.getProofStatement(ken.hackerNews.body)
