 ...
 * or rejects with an error
 */
export declare function getUserAppFileUrl(path: string, username: string, appOrigin: string, zoneFileLookupURL?: string | undefined): Promise<string | null>;
/**
 * Encrypts the data provided with the app public key.
 ...
 * @private
 */
export declare function encryptContentImpl(caller: UserSession, content: string | Buffer, options?: {
    publicKey?: string;
}): string;
/**
 * Decrypts data encrypted with `encryptContent` with the
 ...
 * @private
 */
export declare function getFileImpl(caller: UserSession, path: string, options?: GetFileOptions): Promise<string | ArrayBuffer>;
/**
 * Stores the data provided in the app's data store to to the file specified.
 * @param {UserSession} caller - instance calling this method
 * @param {String} path - the path to store the data in
 ...
 * @private
 */
export declare function listFilesImpl(caller: UserSession, callback: (name: string) => boolean): Promise<number>;
