 ...
 * @param buffer value to be converted to clarity type
 * @returns returns instance of type BufferCV
 * @example
 * ```
 ...
 * @param string input to be converted to bufferCV clarity type
 * @returns returns instance of type BufferCV
 * @example
 * ```
