...
test('fromTwos', () => {
  ...
  expect(Number(fromTwos(BigInt('0xffffffffffffffffffffffffffffffff' +
    'fffffffffffffffffffffffffffffffe'),BigInt(256)))).toBe(-2);
  expect(Number(fromTwos(BigInt('0xffffffffffffffffffffffffffffffff' +
    'ffffffffffffffffffffffffffffffff'),BigInt(256)))).toBe(-1);
  expect(
    fromTwos(BigInt('0x7fffffffffffffffffffffffffffffff' +
      'ffffffffffffffffffffffffffffffff'),BigInt(256)).toString(10))
  ...
  expect(
    fromTwos(BigInt('0x80000000000000000000000000000000' +
      '00000000000000000000000000000000'),BigInt(256)).toString(10))
...
test('toTwos', () => {
  ...
  expect(toTwos(BigInt(-2), BigInt(256)).toString(16))
    .toEqual('fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffe');
  expect(toTwos(BigInt(-1), BigInt(256)).toString(16))
  ...
  expect(toTwos(BigInt('5789604461865809771178549250434395392663' +
    '4992332820282019728792003956564819967'), BigInt(256)).toString(16))
  ...
  expect(toTwos(BigInt('-578960446186580977117854925043439539266' +
    '34992332820282019728792003956564819968'), BigInt(256)).toString(16))
