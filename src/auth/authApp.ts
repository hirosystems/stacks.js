 ...
 * @param blockstackIDHost - the URL to redirect the user to if the blockstack
 ...
 *
 * @param nameLookupURL - the endpoint against which to verify public
 * keys match claimed username
 * @param authResponseToken - the signed authentication response token
 * @param transitKey - the transit private key that corresponds to the transit public key
