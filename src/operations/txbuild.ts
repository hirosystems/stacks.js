 ...
 * @param fullyQualifiedName - the name to preorder
 * @param destinationAddress - the address to receive the name (this
 *    must be passed as the 'registrationAddress' in the register transaction)
 * @param paymentAddress - the address funding the preorder
 * @param paymentUtxos - the number of UTXOs we expect will be required
 ...
 * @param fullyQualifiedName - the name to register
 * @param registerAddress - the address to receive the name
 * @param paymentAddress - the address funding the register
 * @param includingZonefile - whether or not we will broadcast
 ...
 * @param fullyQualifiedName - the name to update
 * @param ownerAddress - the owner of the name
 * @param paymentAddress - the address funding the update
 * @param paymentUtxos - the number of UTXOs we expect will be required
 *    from the payment address.
 * @returns - a promise which resolves to the satoshi cost to fund
 *    the update.
 ...
 * @param fullyQualifiedName - the name to transfer
 * @param destinationAddress - the next owner of the name
 * @param ownerAddress - the current owner of the name
 * @param paymentAddress - the address funding the transfer
 * @param paymentUtxos - the number of UTXOs we expect will be required
 *    from the payment address.
 * @returns - a promise which resolves to the satoshi cost to fund
 *    the transfer.
...
/**
 * Estimates cost of an transfer transaction for a domain name.
 * @param fullyQualifiedName - the name to renew
 * @param destinationAddress - the next owner of the name
 * @param ownerAddress - the current owner of the name
 * @param paymentAddress - the address funding the transfer
 * @param includingZonefile - whether or not we will broadcast a zonefile hash
 ...
 * @param fullyQualifiedName - the name to revoke
 * @param ownerAddress - the current owner of the name
 * @param paymentAddress  the address funding the revoke
 * @param paymentUtxos - the number of UTXOs we expect will be required
 *    from the payment address.
 ...
 * @param namespaceID - the namespace to preorder
 * @param revealAddress - the address to receive the namespace (this
 ...
 * @param namespace - the namespace to reveal
 * @param revealAddress - the address to receive the namespace
 *    (this must have been passed as 'revealAddress' to a prior namespace
 *    preorder)
 * @param paymentAddress - the address that pays for this transaction
 * @param paymentUtxos - the number of UTXOs we expect will be required
 *    from the payment address
 ...
 * @param namespaceID - the namespace to ready
 * @param revealUtxos - the number of UTXOs we expect will
 ...
 * @param recipientAddr - the recipient
 * @param zonefileHash - the zone file hash
 * @param importUtxos - the number of UTXOs we expect will
 ...
 * @param senderUtxos - the number of utxos we expect will
 *  be required from the importer address
 * @returns - a promise which resolves to the satoshi cost
 ...
 * @param tokenType - the type of token to spend
 * @param tokenAmount - a 64-bit unsigned BigInteger encoding the number of tokens
 *   to spend
 * @param scratchArea - an arbitrary string to store with the transaction
 * @param senderUtxos - the number of utxos we expect will
 *  be required from the importer address
 * @param additionalOutputs - the number of outputs we expect to add beyond
 ...
 * @param fullyQualifiedName - the name to pre-order
 * @param destinationAddress - the address to receive the name (this
 *    must be passed as the 'registrationAddress' in the register transaction)
 * @param paymentKeyIn - a hex string of
 *    the private key used to fund the transaction or a transaction signer object
 * @param buildIncomplete - optional boolean, defaults to false,
 ...
 * @param fullyQualifiedName - the name to register
 * @param registerAddress - the address to receive the name (this
 ...
 * @param zonefile - the zonefile data to include (this will be hashed
 *    to include in the transaction), the zonefile itself must be published
 *    after the UPDATE propagates.
 * @param valueHash - the hash of the zone file data to include.
 ...
 * @param fullyQualifiedName - the name to transfer
 * @param destinationAddress - the address to receive the name.
 *    this address will receive a dust UTXO
 * @param ownerKeyIn - a hex string of
 ...
 * @param keepZonefile - if true, then preserve the name's zone file
 * @param buildIncomplete - optional boolean, defaults to false,
 *   indicating whether the function should attempt to return an unsigned (or not fully signed)
 *   transaction. Useful for passing around a TX for multi-sig input signing.
 * @returns - a promise which resolves to the hex-encoded transaction.
 ...
 * @param fullyQualifiedName - the name to transfer
 * @param destinationAddress - the address to receive the name after renewal
 *    this address will receive a dust UTXO
 * @param ownerKeyIn - a hex string of
 *    the current owner's private key (or a TransactionSigner object)
 * @param paymentKeyIn - a hex string of
 ...
 *    object)
 * @param zonefile - the zonefile data to include, if given (this will be hashed
 *    to include in the transaction), the zonefile itself must be published
 *    after the RENEWAL propagates.
 * @param valueHash - the raw zone file hash to include (this will be used
 ...
 * @param namespaceID - the namespace to pre-order
 * @param revealAddress - the address to receive the namespace (this
 *    must be passed as the 'revealAddress' in the namespace-reveal transaction)
 * @param paymentKeyIn - a hex string of
 *    the private key used to fund the transaction (or a
 ...
 * @param revealAddress - the address to receive the namespace (this
 *   must be passed as the 'revealAddress' in the namespace-reveal transaction)
 * @param paymentKeyIn - a hex string (or
 ...
 * @param namespaceID - the namespace to launch
 * @param revealKeyIn - the private key
 ...
 * @param recipientAddr - the address to receive the name
 * @param zonefileHash - the hash of the zonefile to give this name
 * @param importerKeyIn - the private key
 ...
 * @param messageHash - the hash of the message to send.  Should be
 *  an already-announced zone file hash
 * @param senderKeyIn - the private key
 ...
 * @param tokenType - the type of tokens to send
 * @param tokenAmount - the BigInteger encoding of an unsigned 64-bit number of
 *  tokens to send
 * @param scratchArea - an arbitrary string to include with the transaction
 * @param senderKeyIn - the hex-encoded private key to send
 *   the tokens
 * @param btcFunderKeyIn - the hex-encoded private key to fund
 ...
 *
 * @param destinationAddress - the address to receive the bitcoin payment
 * @param paymentKeyIn - the private key
 *    used to fund the bitcoin spend
 * @param amount - the amount in satoshis for the payment address to
