 ...
 * @param txBuilderIn - a transaction builder object to add the inputs to. this
 ...
 * @param utxos - the utxo set for the
 *    payer's address.
 * @param amountToFund - the amount of satoshis to fund in the transaction. the payer's
 *    utxos will be included to fund up to this amount of *output* and the corresponding *fees*
 *    for those additional inputs
 * @param feeRate - the satoshis/byte fee rate to use for fee calculation
 * @param fundNewFees - if true, this function will fund `amountToFund` and any new fees
