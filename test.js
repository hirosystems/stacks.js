...
test('testAuthResponse', function(t) {
    ...
    var authResponse = new AuthResponse(privateKeyHex, publicKeyHex, challenge, blockchainid, publicKeychain, chainPath),
        ...
        decodedAuthRequestToken = authResponse.decode()
    ...
    t.equal(decodedAuthRequestToken.payload.issuer.publicKey, publicKeyHex, 'token public key hex should match the reference value')
